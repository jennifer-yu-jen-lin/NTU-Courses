...
append(bootstrap.β0, β1.bt[1]) # add the SE(β0) calculated by normal theory (total:1001)
append(bootstrap.β1, β1.bt[2]) # add the SE(β1) calculated by normal theory (total:1001)
